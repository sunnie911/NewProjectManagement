<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cert.aspx.cs" Inherits="cert" EnableViewState="false" %>
...
<!--content-->
<div class="plistkp">
    <div class="c_local1">当前位置：<a href="/">首页</a> &gt; <a href="about_1.html">关于我们</a> &gt; <a href="partner_1.html">资质证书</a></div>
    <div class="blank10 clear"></div>
    <div class="smc1">
<ul>
<li><a href="/about_1.html" title="公司简介">公司简介</a></li>    
<li><a href="/partner_1.html" title="合作伙伴">合作伙伴</a></li>    
<li class="showmj"><a href="/cert_1.html" title="资质证书">资质证书</a></li>
...
<br />
 ...
 <asp:Repeater ID="FactoryPicList" runat="server">
      <ItemTemplate> 
      <div class="box2019">
		         <a title="<%#Eval("FacPicTitle") %>" href="certpic_detail-<%#Eval("FacPicID") %>.html"><img src="/upimage/<%#Eval("PicPathSmall")%>" alt="<%#Eval("FacPicTitle") %>" width="150" height="210"></a>
		         <p><a title="<%#Eval("FacPicTitle") %>" href="certpic_detail-<%#Eval("FacPicID") %>.html"><%#cutstr(Eval("FacPicTitle").ToString(), 50)%></a></p>
		       </div>
      </ItemTemplate>
    </asp:Repeater>
			   <div class="clear"></div>
...
<webdiyer:AspNetPager ID="AspNetPager1" runat="server" AlwaysShow="True" CustomInfoHTML="共有  <b><font color='red'>%RecordCount%</font></b>  条记录 当前页<b><font color='red'>%CurrentPageIndex%</font>/%PageCount%</b>   次序 %StartRecordIndex%-%EndRecordIndex%"
      ...
      Width="98%" CustomInfoTextAlign="Left" UrlPaging="True" EnableUrlRewriting="True" 
                   UrlRewritePattern="cert_{0}.html">
