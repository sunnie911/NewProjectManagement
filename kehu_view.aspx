<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kehu_view.aspx.cs" Inherits="kehu_view" EnableViewState="false" %>
...
<br />
    ...
    <div style="text-align:center;"><h1 class="contitle"><%#FacPicTitle%></h1></div><br /><br />
    <div class="aboutcontent"><%#FacPicContent%></div>
    ...
    <div><span class="fbold">&nbsp;企业风采</span><br /></div>
        <div class="tj4pkp">
    <asp:Repeater ID="ProductListNew" runat="server">
      <ItemTemplate>  
		       <div class="box2019">
		         <a title="<%#Eval("FacPicTitle") %>" href="kehu_detail-<%#Eval("FacPicID") %>.html"><img src="/upimage/<%#Eval("PicPathSmall")%>" alt="<%#Eval("FacPicTitle") %>" width="175" height="131"></a>
