<%@ Page Language="C#" AutoEventWireup="true" CodeFile="send_job_prs.aspx.cs" Inherits="enet0769_admin_send_job_prs" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">发布招聘职位</td>
				</tr>
			</table>
			<TABLE cellSpacing="1" cellPadding="3" width="96%" align="center" bgColor="#77aeee" border="0">
                <tr>
                    <td bgcolor="#ffffff" style="height:25px;">发布招聘职位成功。<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="send_job.aspx">发布新的招聘职位</asp:HyperLink></td>
                </tr>
                </TABLE>
    </form>
</body>
