<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_friendlink.aspx.cs" Inherits="enet0769_admin_edit_friendlink" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">修改友情链接</td>
				</tr>
			</table>
  ...
  <tr>
   ...
   <tr>
    ...
    <td style="background-color:#ffffff;">
        <asp:TextBox ID="LinkUrl" runat="server" Columns="45" MaxLength="50"></asp:TextBox>
