<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_facpic.aspx.cs" Inherits="enet0769_admin_edit_facpic" ValidateRequest="false" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">修改案例图片</td>
				</tr>
			</table>
            <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
			...
			<table cellspacing="1" cellpadding="3" width="96%" align="center" bgcolor="#77aeee" border="0">
               ...
               <tr>
                ...
                <tr>
                    ...
                    <asp:Image ID="FacPic" runat="server" Width="80px" />
                    </td>
                </tr>
               <tr>
                    <th align="right" bgcolor="#dfefff" style="height:25px; padding-top:7px;" valign="top">
