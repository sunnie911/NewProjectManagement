<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_site_info.aspx.cs" Inherits="enet0769_admin_manage_site_info" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">管理站点信息</td>
				</tr>
			</table>
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td>
					<asp:GridView ID="GridView1" runat="server" Width="100%"  DataKeyNames ="SiteInfoID" CellPadding ="4" AutoGenerateColumns="False" BackColor="#77aeee" BorderColor="#77aeee" BorderStyle="Solid">
                            <Columns>
                                <asp:BoundField DataField="SiteInfoID" HeaderText="编号ID" >
                                    <ControlStyle Width="60px" />
                                </asp:BoundField>
                                <asp:HyperLinkField DataNavigateUrlFields="SiteInfoID" DataNavigateUrlFormatString="edit_site_info.aspx?SiteInfoID={0}"
                                    DataTextField="SiteInfoTitle" HeaderText="信息标题">
                                    <ControlStyle Width="250px" />
                                </asp:HyperLinkField>
                                 <asp:BoundField DataField="SiteClassName" HeaderText="信息分类" >
                                    <ControlStyle Width="60px" />
                                </asp:BoundField>                                                           
                               <asp:BoundField DataField="AddTime" DataFormatString="{0:yyyy-M-d}" HeaderText="加入时间" >
                                ...
                                <ItemTemplate>
										<a href='edit_site_info.aspx?SiteInfoID=<%#Eval("SiteInfoID")%>' >编辑</a>
