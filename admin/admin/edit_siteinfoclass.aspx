<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_siteinfoclass.aspx.cs" Inherits="enet0769_admin_edit_siteinfoclass" %>
...
<body>
    <form id="form1" runat="server">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">修改站点信息分类</td>
				</tr>
			</table>
