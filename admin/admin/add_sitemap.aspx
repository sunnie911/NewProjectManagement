<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_sitemap.aspx.cs" Inherits="admin_admin_add_sitemap" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">增加站点地图链接</td>
				</tr>
			</table>
  ...
  <tr>
     <th align="right" bgcolor="#dfefff" style="height:25px; padding-top:7px;" valign="top">优先权比值：</th>
          <td bgcolor="#ffffff"><asp:DropDownList ID="SitemapPriority" runat="server" 
              ...
              <asp:ListItem Selected="True">0.8</asp:ListItem>
