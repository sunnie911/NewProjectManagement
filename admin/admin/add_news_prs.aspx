<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_news_prs.aspx.cs" Inherits="enet0769_admin_add_news_prs" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<TABLE cellSpacing="1" cellPadding="3" width="96%" align="center" bgColor="#77aeee" border="0">
                <tr>
                    <td bgcolor="#ffffff">增加公司新闻成功。<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="add_news.aspx">增加新的公司新闻</asp:HyperLink></td>
                </tr>
                </TABLE>
    </form>
</body>
