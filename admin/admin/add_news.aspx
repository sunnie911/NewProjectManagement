<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_news.aspx.cs" Inherits="enet0769_admin_add_news" ValidateRequest="false" %>
...
<head runat="server">
	...
	<script>
	    ...
	    $(document).ready(function() {
	        document.getElementById("ReleaseTime").value = today();
	    });
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">增加公司新闻</td>
				</tr>
			</table>
            <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
			...
			<table cellspacing="1" cellpadding="3" width="96%" align="center" bgcolor="#77aeee" border="0">
                ...
                <tr>
                    <th align="right" bgcolor="#dfefff" width="120" style="height:25px">新闻图片：</th>
