<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_friend_link_prs.aspx.cs" Inherits="enet0769_admin_add_friend_link_prs" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<TABLE cellSpacing="1" cellPadding="3" width="96%" align="center" bgColor="#77aeee" border="0">
                <tr>
                    <td bgcolor="#ffffff" style="height:25px;">增加友情链接成功。<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="add_friendlink.aspx">增加新的友情链接</asp:HyperLink></td>
                </tr>
                </TABLE>
    </form>
</body>
