<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_facpic.aspx.cs" Inherits="enet0769_admin_add_facpic" ValidateRequest="false" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table cellspacing="1" cellpadding="3" width="96%" align="center" bgcolor="#77aeee" border="0">
                <tr>
                    <th align="right" bgcolor="#dfefff" width="120" style="height:25px">图片标题：</th>
                    <td bgcolor="#ffffff">
                        <asp:TextBox ID="FacPicTitle" runat="server" Columns="60" MaxLength="255"></asp:TextBox><br />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="请输入图片标题" ControlToValidate="FacPicTitle" Display="Dynamic"></asp:RequiredFieldValidator></td>
                </tr>
                <tr>
                    <th align="right" bgcolor="#dfefff" width="120" style="height:25px">工厂图片：</th>
               ...
               <tr>
                    <th align="right" bgcolor="#dfefff" style="height:25px; padding-top:7px;">
                        图片分类：</th>
                    <td bgcolor="#ffffff"><asp:DropDownList ID="PicClassID" runat="server">
                        </asp:DropDownList></td>
                </tr>
               <tr>
                    <th align="right" bgcolor="#dfefff" style="height:25px; padding-top:7px;">
               ...
               <tr>
                    <th align="right" bgcolor="#dfefff" style="height:25px; padding-top:7px;" valign="top">图片内容：</th>
                    <td bgcolor="#ffffff">
                ...
                <tr>
                    ...
                    <td bgcolor="#ffffff"><asp:button id="btn_Ok" runat="server" Text=" 添加 " OnClick="btn_Ok_Click" ></asp:button>
