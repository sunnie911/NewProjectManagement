<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_project_case.aspx.cs" Inherits="enet0769_admin_add_project_case" ValidateRequest="false" %>
			...
			<table cellspacing="1" cellpadding="3" width="96%" align="center" bgcolor="#77aeee" border="0">
                <tr>
                    ...
                    <td bgcolor="#ffffff">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="请输入视频名称" ControlToValidate="ProjectName" Display="Dynamic"></asp:RequiredFieldValidator></td>
                </tr>
                <tr>
               ...
               <tr>
                    <th align="right" bgcolor="#dfefff" style="height:25px; padding-top:7px;" valign="top">视频详情：</th>
                    <td bgcolor="#ffffff">
