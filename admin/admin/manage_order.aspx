<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_order.aspx.cs" Inherits="enet0769_admin_manage_order" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td>
					<asp:GridView ID="GridView1" runat="server" Width="100%"  DataKeyNames ="OrderID" CellPadding ="4" AutoGenerateColumns="False" BackColor="#77aeee" BorderColor="#77aeee" BorderStyle="Solid">
                            <Columns>
                                <asp:BoundField DataField="OrderID" HeaderText="ID编号" >
                                    <ControlStyle Width="60px" />
                                </asp:BoundField>
                                <asp:HyperLinkField DataNavigateUrlFields="OrderID" DataNavigateUrlFormatString="order_detail.aspx?Action=ViewOrder&OrderID={0}"
                                    DataTextField="OrderSubject" HeaderText="订单主题">
                                    <ControlStyle Width="200px" />
                                </asp:HyperLinkField>  
                               <asp:BoundField DataField="Manager" HeaderText="负责人姓名" >
                                    <ControlStyle Width="250px" />
                                </asp:BoundField>                                                        
                               <asp:BoundField DataField="AddTime" DataFormatString="{0:yyyy-M-d}" HeaderText="订购时间" >
                                    <ControlStyle Width="200px" />
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
										<a href='order_detail.aspx?Action=ViewOrder&OrderID=<%#Eval("OrderID")%>' >查看</a>&nbsp;&nbsp;
										<a href='order_detail.aspx?Action=DeleteOrder&OrderID=<%#Eval("OrderID")%>' onclick="javascript:if(confirm('您确定要删除吗？')){return true;}else{return false;}">删除</a>
