<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_site_info_prs.aspx.cs" Inherits="enet0769_admin_add_site_info_prs" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">增加站点信息</td>
				</tr>
			</table>
			<TABLE cellSpacing="1" cellPadding="3" width="96%" align="center" bgColor="#77aeee" border="0">
                <tr>
                    <td bgcolor="#ffffff">增加站点信息成功。<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="add_site_info.aspx">增加新的站点信息</asp:HyperLink></td>
                </tr>
                </TABLE>
    </form>
</body>
