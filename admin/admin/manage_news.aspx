<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_news.aspx.cs" Inherits="enet0769_admin_manage_news" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">管理公司新闻</td>
				</tr>
			</table>
	...
	<td height="32" style="padding-left:8px;">
        ...
        <asp:Button ID="Button1" runat="server" Text=" 搜 索 " OnClick="Button1_Click" />&nbsp;<span class="gray">请输入资讯标题</span></td>
    </tr>
</table>
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td>
					<asp:GridView ID="GridView1" runat="server" Width="100%"  DataKeyNames ="NewsID" CellPadding ="4" AutoGenerateColumns="False" BackColor="#77aeee" BorderColor="#77aeee" BorderStyle="Solid">
                            <Columns>
                                <asp:BoundField DataField="NewsID" HeaderText="编号ID" >
                                    <ControlStyle Width="60px" />
                                </asp:BoundField>
                                <asp:HyperLinkField DataNavigateUrlFields="NewsID" DataNavigateUrlFormatString="../../news_detail-{0}.html"
                                    DataTextField="NewsTitle" HeaderText="新闻标题" Target="_blank" >
                                ...
                                <asp:BoundField DataField="ReleaseTime" DataFormatString="{0:yyyy-M-d HH:mm:ss}" HeaderText="发布时间" >
                                    <ControlStyle Width="100px" />
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
										<a href='edit_news.aspx?Action=EditNews&NewsID=<%#Eval("NewsID")%>' >编辑</a>&nbsp;&nbsp;
										<a href='edit_news.aspx?Action=DeleteNews&NewsID=<%#Eval("NewsID")%>' onclick="javascript:if(confirm('您确定要删除吗？')){return true;}else{return false;}">删除</a>
								</ItemTemplate></asp:TemplateField>
                            </Columns>
