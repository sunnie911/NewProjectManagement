<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_picclass.aspx.cs" Inherits="enet0769_admin_edit_picclass" %>
...
<body>
    <form id="form1" runat="server">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">修改案例分类</td>
				</tr>
			</table>
