<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manage_friendlink.aspx.cs" Inherits="enet0769_admin_manage_friendlink" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">管理友情链接</td>
				</tr>
			</table>
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td>
					<asp:GridView ID="GridView1" runat="server" Width="100%"  DataKeyNames ="LinkID" CellPadding ="4" AutoGenerateColumns="False" BackColor="#77aeee" BorderColor="#77aeee" BorderStyle="Solid">
                            <Columns>
                                <asp:BoundField DataField="LinkID" HeaderText="友情链接ID" >
                                    <ControlStyle Width="60px" />
                                </asp:BoundField>
                                <asp:HyperLinkField DataNavigateUrlFields="LinkUrl" DataNavigateUrlFormatString="{0}"
                                    DataTextField="LinkKeyword" HeaderText="网站名称" Target="_blank" >
                                    <ControlStyle Width="250px" />
                                </asp:HyperLinkField>
                                <asp:BoundField DataField="LinkUrl" HeaderText="链接网址" >
                                    <ControlStyle Width="250px" />
                                </asp:BoundField> 
                                <asp:BoundField DataField="LinkSortID" HeaderText="排序" >
                               ...
                               <asp:BoundField DataField="AddTime" DataFormatString="{0:yyyy-M-d}" HeaderText="发布时间" >
                                ...
                                <ItemTemplate>
										<a href='edit_friendlink.aspx?Action=EditFriendLink&LinkID=<%#Eval("LinkID")%>' >编辑</a>&nbsp;&nbsp;
										<a href='edit_friendlink.aspx?Action=DeleteFriendLink&LinkID=<%#Eval("LinkID")%>' onclick="javascript:if(confirm('您确定要删除吗？')){return true;}else{return false;}">删除</a>
