<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_job.aspx.cs" Inherits="enet0769_admin_edit_job" ValidateRequest="false" %>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
					<td height="30" class="title_top" align="center">修改招聘职位</td>
				</tr>
			</table>
  ...
  <tr>
    ...
    <td style="background-color:#ffffff;"><asp:TextBox ID="JobDemand" runat="server" Columns="42" Rows="6" 
            TextMode="MultiLine"></asp:TextBox></td>
  </tr>
  <tr>
    <th align="right" style="height:25px; background-color:#dfefff;"></th>
    <td style="background-color:#ffffff;">
        <asp:Button ID="Button1" runat="server" Text="确认修改" OnClick="Button1_Update_Click" /></td>
  </tr>
</table>
    </form>
</body>
