...
namespace DanaZhangCms.Core.CodeGenerator
{
    /// <summary>
    /// 代码生成器。
    /// <remarks>
    ...
    public class CodeGenerator
    {
        ...
        private static void GenerateIRepository(string modelTypeName, string keyTypeName, bool ifExsitedCovered = false)
        {
            ...
            var iRepositoryPath =outputPath  + Delimiter + "DanaZhangCms.IRepositories";
        ...
        {
            var repositoryPath = options.Value.OutputPath + Delimiter + "DanaZhangCms.Repositories";
        ...
        {
            var controllerPath = options.Value.OutputPath + Delimiter + "DanaZhangCms.Controllers"+Delimiter+ "System";
            ...
            var fullPath = controllerPath + Delimiter + name + "Controller.cs";
            if (File.Exists(fullPath) && !ifExsitedCovered)
                return;
