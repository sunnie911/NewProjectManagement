<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pdetail.aspx.cs" Inherits="m_pdetail" EnableViewState="false" %>
<%@ Register src="UserControls/adv.ascx" tagname="adv" tagprefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title><%#ProductName%> - 五金公司网站模板手机版</title>
...
<uc2:adv ID="adv1" runat="server" /> 
   ...
   <div align="center" style="padding:10px 1px 10px 10px; font-size:16px;"><b><%#ProductName%></b></div>

  <div align="center"><img src="../upimage/<%#PicPathBig%>" width="300" alt="<%#ProductName%>" title="<%#ProductName%>"/></div>
   
   <div style="padding:20px 10px 20px 10px; background:#FFF; font-size:14px;"><%#ProductContent2%></div>
   ...
   <div style="padding-bottom:15px; padding-top:10px; background:#FFF;"><div class="ph_prolvyuan" style="width:200px; padding-left:15px;"><a href="javascript:history.back(-1)">返回</a>&nbsp;<a href="contact.html">联系我们</a></div></div>
