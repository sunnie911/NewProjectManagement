<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news.aspx.cs" Inherits="m_news" EnableViewState="false" %>
...
<div class="mt10">
        ...
        <ul><li>
         <asp:Repeater ID="rp_NewsList" runat="server">
            <ItemTemplate>
                     <li><a href="ndetail-<%#Eval("NewsID") %>.html" title="<%#Eval("NewsTitle") %>"><%#cutstr(Eval("NewsTitle").ToString(), 18)%></a></li>
            </ItemTemplate>
        </asp:Repeater>
        </li></ul>
        </div> 
...
<webdiyer:AspNetPager ID="AspNetPager1" runat="server" AlwaysShow="True" CustomInfoHTML="共<b><font color='red'>%RecordCount%</font></b>条" CustomInfoSectionWidth="14%"
            ...
            NextPageText="下一页" NumericButtonCount="5" OnPageChanged="AspNetPager1_PageChanged"
                                        PageSize="10" PrevPageText="上一页" 
            ShowCustomInfoSection="Left" Style="font-size: 12px"
                                        Width="86%" CustomInfoTextAlign="Left" 
            UrlPaging="True" EnableUrlRewriting="True" 
        UrlRewritePattern="news_{0}.html">
